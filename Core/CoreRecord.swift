...
open class CoreRecord {
    ...
    fileprivate init() {
        #if os(iOS)
        NotificationCenter.default.addObserver(self, selector: #selector(CoreRecord.applicationWillTerminate), name: UIApplication.willTerminateNotification, object: nil)
        #endif
    }
    ...
    // singleton
    public static let sharedRecord = CoreRecord()
}

public extension NSManagedObjectContext {
    static var defaultContext: NSManagedObjectContext {
        return CoreRecord.sharedRecord.managedObjectContext
    }
}
